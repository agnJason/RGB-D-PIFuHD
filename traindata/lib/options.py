...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_netG_checkpoint_path', type=str, default='./checkpoint/net_G', help='path to save checkpoints')
        parser.add_argument('--load_netC_checkpoint_path', type=str, default='./checkpoint/net_C', help='path to save checkpoints')
