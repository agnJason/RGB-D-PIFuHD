...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--name', type=str, default='pifuhd',
        ...
        g_train.add_argument('--num_iter', type=int, default=30, help='num iterations to train')
        g_train.add_argument('--freq_plot', type=int, default=100, help='freqency of the error plot')
        g_train.add_argument('--freq_mesh', type=int, default=200, help='freqency of the save_checkpoints')
        g_train.add_argument('--freq_eval', type=int, default=50, help='freqency of the save_checkpoints')
        g_train.add_argument('--freq_save_ply', type=int, default=50, help='freqency of the save ply')
        ...
        g_sample.add_argument('--num_sample_inout', type=int, default=300, help='# of sampling points')
        ...
        # hgimp specific
        g_model.add_argument('--num_stack_global', type=int, default=4, help='# of hourglass')
        g_model.add_argument('--num_stack_local', type=int, default=1, help='# of hourglass')
        ...
        g_model.add_argument('--hg_dim_local', type=int, default=16, help='256 | 512')
        g_model.add_argument('--hg_dim_global', type=int, default=256, help='256 | 512')
        # Classification General
        g_model.add_argument('--mlp_norm', type=str, default='group', help='normalization for volume branch')
        g_model.add_argument('--mlp_dim_global', nargs='+', default=[257, 1024, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp. no need to put the first channel')
        g_model.add_argument('--mlp_dim_local', nargs='+', default=[272, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp. no need to put the first channel')
        g_model.add_argument('--mlp_dim', nargs='+', default=[257, 1024, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp. no need to put the first channel')
        g_model.add_argument('--mlp_res_layers_global', nargs='+', default=[2,3,4], type=int,
                             help='leyers that has skip connection. use 0 for no residual pass')
        g_model.add_argument('--mlp_res_layers_local', nargs='+', default=[1,2], type=int,
                     help='leyers that has skip connection. use 0 for no residual pass')
        ...
        parser.add_argument('--results_path', type=str, default='./result', help='path to save results ply')
        ...
        parser.add_argument('--use_front_normal',default=True, action='store_true')
        parser.add_argument('--use_back_normal',default=True, action='store_true')
        ...
        parser.add_argument('--use_color', type=int, default=-0, help='way of colored')
        # special tasks
